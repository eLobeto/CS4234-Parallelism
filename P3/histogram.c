...
int thread_count, data_per_thread, leftover_data, thread_finished_ctr;
float* data;
int* bin_counts;
...
int main(int argc, char* argv[]) {
   ...
   Get_args(argv, &thread_count, &bin_count, &min_meas, &max_meas, &data_count);
   ...
   data_per_thread = data_count / thread_count;
   leftover_data = data_count % thread_count;
